...
# Accord Protocol Template: delivery-contract
...
```
cicero parse --template ./delivery-contract/ --dsl ./delivery-contract/sample.txt
...
```
cicero execute --template ./delivery-contract/ --dsl ./delivery-contract/sample.txt --data ./delivery-contract/data.json 
```
